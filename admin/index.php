                          ...
                          <div >
                            ...
                            <div class="mt-4">
                                ...
                                <div class="relative  "  x-data="{ isVisible: false }">
                                    <div class="absolute flex right-0 items-center peer-focus:bg-red-600  h-full  w-[45px] justify-center ">
                                      <button type="button" class="px-1 block focus:outline-none" @click="$dispatch('visibility'); isVisible = !isVisible;">
                                      ...
                                      <input type="password" id="password" name="password"  @visibility.window="$el.type = ($el.type == 'password') ? 'text' : 'password' " required class=" focus:shadow-md shadow-sm block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-sm border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
