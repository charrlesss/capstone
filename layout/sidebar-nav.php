...
<div id="backgroud-modal-active" class="self-start md:hidden hidden absolute inset-0 bg-gray-500 opacity-30 z-[100]  "></div>
<div id="sidebar" class=" self-start z-[9999]  md:relative fixed py-12 bg-white min-h-screen transition-all ease-in-out md:w-[300px] w-[280px] shadow-lg">
