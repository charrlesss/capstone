     ...
     <div class='z-[1]  px-10 w-full h-auto  bg-transparent absolute top-[45%] left-[50%] -translate-x-[50%] -translate-y-[50%]'>
            ...
            <div class='md:w-[700px] h-auto bg-white rounded-2xl shadow-lg mx-auto'>
                <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                    <form id="send_complain" class="space-y-8">
                        <div>
...
$("#send_complain").submit(function(e){
  e.preventDefault()
  const formData =new FormData(e.currentTarget);
  $.ajax({
    url:"<?php echo "$url/controller/administrative/legal-management.php/send_complains" ?>",
    type:"POST",
    data:formData,
    processData: false,
    contentType: false,
